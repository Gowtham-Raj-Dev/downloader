              ...
              >
                ...
                <div className="max-w-4xl mx-auto px-4 mt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
                  ...
                  <div className="glass-card p-5 rounded-card border border-neutral-200/40 dark:border-neutral-800/20 text-center">
                    ...
                    <h4 className="text-sm font-bold text-neutral-800 dark:text-neutral-200 mb-1">Batch Video Extractor</h4>
                    <p className="text-xs text-neutral-500 dark:text-neutral-500 leading-relaxed">
                      Paste multiple post or reel links to fetch details, play the media, and trigger direct downloads instantly.
                    </p>
                  </div>
                  ...
                  <div className="glass-card p-5 rounded-card border border-neutral-200/40 dark:border-neutral-800/20 text-center">
                    ...
                    <p className="text-xs text-neutral-500 dark:text-neutral-500 leading-relaxed">
                      Download all fetched videos to your device in a single action.
                    </p>
                  </div>
                </div>
              </motion.div>
